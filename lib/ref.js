...
exports.ref = function ref (buffer) {
  if( exports.isNull(buffer) && exports.NULL_POINTER !== undefined ) {
    return exports.NULL_POINTER;  
  }
...
exports.isNullPointer = function isNullPointer(buffer) {
  return buffer === exports.NULL_POINTER;
};
...
Buffer.prototype.isNullPointer = function isNullPointer() {
  return this === exports.NULL_POINTER;
};
